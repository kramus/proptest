...
We can see that for years 2005, 2008, 2012 the results were not statistically significant (`r p_value[c(2,5,9)]` respectively). Further investigation will be needed in order to have a better insight of the behavior of HIV mortality in Puerto Rico. 
